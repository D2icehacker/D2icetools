...
def Menu():
   ...
   banner = f"""{popup_version}                                                                                      
  			...
  			_____ ___  _____ _____ ______ _______ ____   ____  _       _____ 
 			|  __ \__ \|_   _/ ____|  ____|__   __/ __ \ / __ \| |     / ____|
 			| |  | | ) | | || |    | |__     | | | |  | | |  | | |    | (___  
 			| |  | |/ /  | || |    |  __|    | | | |  | | |  | | |     \___ \ 
 			| |__| / /_ _| || |____| |____   | | | |__| | |__| | |____ ____) |
 			|_____/____|_____\_____|______|  |_|  \____/ \____/|______|_____/ 
...
while True:
   try:
      ...
      choice = input(MainColor(f""" ┌───({white}{username_pc}@d2icetools)─{red}[{white}~/D2iceTools/Menu-{menu_number}]
 └──{white}$ {reset}"""))
